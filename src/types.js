...
/** @typedef {{ id: string, name: string, slug?: string, branding?: object, pricing_defaults?: object }} Workspace */
/** @typedef {{ id: string, workspace_id: string, user_id: string, role: 'admin' | 'estimator' | 'sales' }} WorkspaceMember */
