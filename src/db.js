...
function mapQuoteFromDb(row) {
  return {
    ...
    tasks: row.tasks || [],
    addons: row.addons || [],
    workHours: row.work_hours || { start: '8:00 AM', end: '5:00 PM', overnight: false },
    ...
    whyOverrides: row.why_overrides || {},
    editHistory: row.edit_history || [],
    discountPct: (row.discount_pct === null || row.discount_pct === undefined) ? 0 : row.discount_pct,
    date: row.date,
...
function mapQuoteToDb(quote, workspaceId) {
  return {
    ...
    tasks: quote.tasks || [],
    addons: quote.addons || [],
    work_hours: quote.workHours || { start: '8:00 AM', end: '5:00 PM', overnight: false },
    ...
    why_overrides: quote.whyOverrides || {},
    edit_history: quote.editHistory || [],
    discount_pct: quote.discountPct ?? null,
    date: quote.date,
